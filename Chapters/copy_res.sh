...
cp $PATH_WD/Benchmark_results/change_mrna_prot*.pdf 1/
...
cp $PATH_WD/Robustness/scatterplot_*pep_vs_no_pep.png 4/
cp $PATH_WD/Robustness/change_mrna_prot_*pep_vs_no_pep.pdf 4/
